...
export declare class CredentialMapper {
    ...
    static isCredential(original: OriginalVerifiableCredential | OriginalVerifiablePresentation): boolean;
    static isPresentation(original: OriginalVerifiableCredential | OriginalVerifiablePresentation): boolean;
