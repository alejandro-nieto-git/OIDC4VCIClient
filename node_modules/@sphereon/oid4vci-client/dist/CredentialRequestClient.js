...
class CredentialRequestClient {
    ...
    acquireCredentialsUsingProof(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            const { credentialDefinition, proofInput, credentialTypes, context, format } = opts; // Declare the 'credentialDefinition' property
            const request = yield this.createCredentialRequest({ credentialDefinition, proofInput, credentialTypes, context, format, version: this.version() });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (format === 'jwt_vc_json' || format === 'jwt_vc') {
                return {
                    ...
                    format,
                    proof,
                    credentialSubject: opts.credentialDefinition.credentialSubject,
                };
            }
