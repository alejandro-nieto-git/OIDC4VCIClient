...
describe.skip('OID4VCI-Client using Mattr issuer should', () => {
    ...
    it('succeed in a full flow with the client using OpenID4VCI version 11 and ldp_vc', () => __awaiter(void 0, void 0, void 0, function* () {
        yield test('ldp_vc');
...
function getCredentialOffer(format) {
    return __awaiter(this, void 0, void 0, function* () {
        const credentialOffer = yield (0, cross_fetch_1.fetch)('https://launchpad.mattrlabs.com/api/credential-offer', {
            method: 'post',
            headers: {
...
//# sourceMappingURL=MattrE2E.spec.test.js.map