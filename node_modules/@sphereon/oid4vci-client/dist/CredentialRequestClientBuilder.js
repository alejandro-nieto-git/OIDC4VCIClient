...
class CredentialRequestClientBuilder {
    ...
    static fromURI(_a) {
        return __awaiter(this, arguments, void 0, function* ({ credentialDefinition, uri, metadata }) {
            const offer = yield CredentialOfferClient_1.CredentialOfferClient.fromURI(uri);
            return CredentialRequestClientBuilder.fromCredentialOfferRequest(Object.assign(Object.assign({ credentialDefinition, request: offer }, offer), { metadata, version: offer.version }));
        });
    }
    ...
    static fromCredentialOffer({ credentialDefinition, credentialOffer, metadata, }) {
